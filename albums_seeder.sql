...
values('Michael Jackson', 'Thriller', 1982, 50.2, 'Pop, post-disco, funk, rock'),
      ...
      ('Meat Loaf', 'Bat Out of Hell', 1977, 22, 'Hard rock, glam rock, progressive rock'), ('Eagles', 'Hotel California', 1976, 31.8, 'Soft rock'),
      ('Bee Gees', 'Saturday Night Fever', 1977, 22.1, 'Disco'),
      ('FLeetwood Mack', 'Rumours', 1977, 30.3, 'Soft rock'),
      ('Shanaia Twain', 'Come On Over', 1997, 30.4, 'Country, Pop'),
      ('Led Zeppelin', 'Led Zeppelin IV', 1971, 30.4, 'Hard rock, heavy metal, folk rock'), ('Michael Jackson', 'Bad', 1987, 21.2, 'Pop, rhythm and blues, funk and rock'),
